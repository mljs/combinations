...
describe('Compute combinations', function () {
    it('should generate 1 of N combinations (index mode)', function () {
        ...
        [...combinations(1, 8, options)].should.eql([[7], [0], [1], [2], [3], [4], [5], [6]]);
        [...combinations(1, 1)].should.eql([[0]]);
        [...combinations(1, 2)].should.eql([[1], [0]]);
    });

    it('should generate 1 of N combinations (mask mode)', function () {
        var options = {mode: 'mask'};
        [...combinations(1, 1, options)].should.eql([[1]]);
        [...combinations(1, 2, options)].should.eql([[0, 1], [1, 0]]);
    });
    ...
    it('should generate some more complicated comibinations', function () {
        [...combinations(2, 4)].should.eql([[3, 2], [0, 2], [1, 2], [1, 2], [0, 2], [0, 1]]);
    });
});
